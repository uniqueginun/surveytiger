    ...
    <div class="container-fluid fixed-top p-4">
      <div class="col-12">
        <div v-if="canLogin" class="d-flex justify-content-end">
          <div>
            <Link v-if="$page.props.user" :href="route('dashboard')" class="text-secondary text-decoration-none">
              Dashboard
            </Link>

            <template v-else>
              <Link :href="route('login')" class="text-secondary text-decoration-none">
                Log in
              </Link>

              <Link v-if="canRegister" :href="route('register')" class="ms-4 text-secondary text-decoration-none">
                Register
              </Link>
            </template>
          </div>
    ...
    <div class="container-fluid my-5 pt-5 px-5">
      <div class="row justify-content-center px-4">
        <div class="col-md-12 col-lg-9">
          <jet-application-mark width="120"></jet-application-mark>
